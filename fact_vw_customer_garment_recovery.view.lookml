- view: fact_vw_customer_garment_recovery
  sql_table_name: FACT_VW_Customer_Garment_Recovery
  fields:
  ...
  - dimension: product_purchase_retail_price
    type: number
    sql: ${TABLE}.Product_Purchase_Retail_Price

  - dimension: product_sku
    sql: ${TABLE}.Product_SKU

  - dimension: product_ttb_sale_price
    type: number
    sql: ${TABLE}.Product_TTB_Sale_Price

  - dimension: product_ttb_sale_tax_price
    type: number
    sql: ${TABLE}.Product_TTB_Sale_Tax_Price

  - dimension: product_ttb_sale_total_price
    type: number
    sql: ${TABLE}.Product_TTB_Sale_Total_Price
