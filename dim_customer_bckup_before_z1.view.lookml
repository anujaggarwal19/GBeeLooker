- view: dim_customer_bckup_before_z1
  sql_table_name: DIM_Customer_BckupBeforeZ1
  fields:
  ...
  - measure: count
    type: count
    drill_fields: [customer_last_name, customer_first_name, customer_shipping_name, customer_name, customer_plan_name]
