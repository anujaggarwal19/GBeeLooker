- view: dim_customer_backup20140923
  sql_table_name: DIM_CUSTOMER_BACKUP20140923
  fields:
  ...
  - measure: count
    type: count
    drill_fields: [customer_plan_name, customer_name, customer_last_name, customer_first_name, customer_shipping_name]
