- view: dim_customer_temp
  sql_table_name: DIM_Customer_Temp
  fields:
  ...
  - measure: count
    type: count
    drill_fields: [customer_shipping_name, customer_first_name, customer_last_name, customer_plan_name, customer_name]
