- view: dim_customer_bkp_20141010
  sql_table_name: DIM_Customer_BKP_20141010
  fields:
  ...
  - measure: count
    type: count
    drill_fields: [customer_name, customer_plan_name, customer_shipping_name, customer_first_name, customer_last_name]
